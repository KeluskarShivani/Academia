<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Teachers.aspx.cs" Inherits="AcademiaApp.Teachers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
        <span class="tdHeader">All Teachers</span>
        <br /><br />
    <asp:GridView runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" ID="grdTeachers">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <center><a href="Teachers.aspx?del=<%#Eval("USER_ID") %>" class="tdLinkLabel" onclick="return confirm('Are you sure want to delete?')">Delete</a></center>
                </ItemTemplate>
            </asp:TemplateField>
                        <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <center><a href="Teachers.aspx?rec=<%#Eval("USER_ID") %>" class="tdLinkLabel" onclick="return confirm('Are you sure want to recover?')">Recover</a></center>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
