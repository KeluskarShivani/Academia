<%@ Page Title="" Language="C#" MasterPageFile="~/Master/StudentMaster.Master" AutoEventWireup="true" CodeBehind="Requests.aspx.cs" Inherits="AcademiaApp.Requests" %>
                ...
                <td style="vertical-align:top">
                    <asp:ListView ID="listFriends" runat="server" DataKeyNames="USER_ID,BASIC_DET_ID" DataSourceID="SqlDataSourceFriends" >
                        ...
                        <table style="width:100%;border-collapse:collapse">
                            ...
                            <tr>
                            <td runat="server" visible='<%# Eval("REQ_TO").ToString().ToUpper() == Session["USER_ID"].ToString().ToUpper() ? true : false%>'>
                                <a href="Requests.aspx?acp=<%#Eval("FRND_REQ_ID")%>&rf=<%#Eval("REQ_FROM")%>" class="buttonMedium" style="text-decoration:none;border:1px solid #d31111;padding:3px;" onclick="return confirm('Are you sure want to accept this request?')">Accept Request</a>
                            
                            </td>
                                <td>
                            <a href="Requests.aspx?del=<%#Eval("FRND_REQ_ID")%>" class="buttonMedium" style="text-decoration:none;border:1px solid #d31111;padding:3px;" onclick="return confirm('Are you sure want to delete this request?')">Delete Request</a>                                    
                            </td>
                             <td>
